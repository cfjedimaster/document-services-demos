...
import { makeSample } from './pdfProcessorv2.js';
...
const SAMPLE_SIZE = 5;
// The Word document used to prepend to the sample
const PREPEND_DOC = './prepend.docx';
...
for(let i=0; i<pdfsToProcess.length; i++) {
	...
	await makeSample(p, PREPEND_DOC, SAMPLE_SIZE, `${fileName}`);
}